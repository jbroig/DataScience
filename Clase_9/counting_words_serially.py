...
def word_count():
    ...
    #Por cada linea, quitamos los espacios del principio y final, y hacemos split por espacios.
    for line in sys.stdin:
        data = line.strip().split(" ")
        
        # Your code here
        #Por cada palabra en la linea, quitamos las signos de puntuacion y lo hacemos lowercase.
        for i in data:
